...
import com.panic08.funpay4j.AuthorizedFunPayExecutor;
...
public class GetSellerReviews {
    public static void main(String[] args) {
        ...
        try {
            sellerReviews = authorizedExecutor.execute(com.panic08.funpay4j.commands.user.GetSellerReviews.builder()
                    .pages(2)
                    .userId(1940073L)
                    .starsFilter(null)
                    .build());
